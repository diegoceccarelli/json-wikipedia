...
public class Table extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static it.cnr.isti.hpc.wikipedia.Table.Builder newBuilder() {
    return new it.cnr.isti.hpc.wikipedia.Table.Builder();
  }
   ...
   * @return A new Table RecordBuilder
   */
  public static it.cnr.isti.hpc.wikipedia.Table.Builder newBuilder(it.cnr.isti.hpc.wikipedia.Table.Builder other) {
    return new it.cnr.isti.hpc.wikipedia.Table.Builder(other);
  }
   ...
   * @return A new Table RecordBuilder
   */
  public static it.cnr.isti.hpc.wikipedia.Table.Builder newBuilder(it.cnr.isti.hpc.wikipedia.Table other) {
    return new it.cnr.isti.hpc.wikipedia.Table.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Table>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(it.cnr.isti.hpc.wikipedia.Table.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(it.cnr.isti.hpc.wikipedia.Table other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.title)) {
        this.title = data().deepCopy(fields()[0].schema(), other.title);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public it.cnr.isti.hpc.wikipedia.Table.Builder setTitle(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.cnr.isti.hpc.wikipedia.Table.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public it.cnr.isti.hpc.wikipedia.Table.Builder setNumCols(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.cnr.isti.hpc.wikipedia.Table.Builder clearNumCols() {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.cnr.isti.hpc.wikipedia.Table.Builder setNumRows(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.cnr.isti.hpc.wikipedia.Table.Builder clearNumRows() {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.cnr.isti.hpc.wikipedia.Table.Builder setTable(java.util.List<java.util.List<java.lang.String>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.cnr.isti.hpc.wikipedia.Table.Builder clearTable() {
      table = null;
