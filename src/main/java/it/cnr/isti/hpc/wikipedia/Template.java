...
public class Template extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static it.cnr.isti.hpc.wikipedia.Template.Builder newBuilder() {
    return new it.cnr.isti.hpc.wikipedia.Template.Builder();
  }
   ...
   * @return A new Template RecordBuilder
   */
  public static it.cnr.isti.hpc.wikipedia.Template.Builder newBuilder(it.cnr.isti.hpc.wikipedia.Template.Builder other) {
    return new it.cnr.isti.hpc.wikipedia.Template.Builder(other);
  }
   ...
   * @return A new Template RecordBuilder
   */
  public static it.cnr.isti.hpc.wikipedia.Template.Builder newBuilder(it.cnr.isti.hpc.wikipedia.Template other) {
    return new it.cnr.isti.hpc.wikipedia.Template.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Template>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(it.cnr.isti.hpc.wikipedia.Template.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(it.cnr.isti.hpc.wikipedia.Template other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public it.cnr.isti.hpc.wikipedia.Template.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.cnr.isti.hpc.wikipedia.Template.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public it.cnr.isti.hpc.wikipedia.Template.Builder setDescription(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.cnr.isti.hpc.wikipedia.Template.Builder clearDescription() {
      description = null;
