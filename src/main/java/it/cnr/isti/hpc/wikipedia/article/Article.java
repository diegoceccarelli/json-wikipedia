...
//		return getCleanParagraphs(this.getParagraphs());
//	}
//
...
//	}
//
//	public static String getCleanText(List<String> cleanedParagraphs) {
...
//			String text = getCleanText(this.getParagraphs());
//			if (text.length() > 1000) {
